...
public class F_DD_1_5_wrong extends Fragment {

    public F_DD_1_5_wrong() {
    }
  ...
  /*      ItemTouchHelper.Callback callback =
        ...
        view.findViewById(R.id.button_forward_dd).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                NavHostFragment.findNavController(F_DD_1_5_wrong.this)
                        .navigate(R.id.action_f_DD_1_5_wrong_to_i_1_6);
            }
