...
public class F_DD_6_10_wrong extends Fragment {

    public F_DD_6_10_wrong() {
    }


    TextView textview;
    String text = "<p><span style=\"color: #ff0000;\">Stimmt leider nicht.</span> Au&szlig;erhalb der Funktion existiert <em><strong>text</strong> </em>nicht und beim Verwenden w&uuml;rden wir eine Fehlermeldung bekommen.</p>";
    Button textview_button;
    String text_button = "Weiter";
    //Progress Text
    TextView progressText;
    String progress = "10 / 15";

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        RecyclerListAdapter3.STRINGS3[0] = "<p><span style=\"color: #0000ff;\">fun</span> addSpace(<span style=\"color: #808080;\">text: String</span>){</p>";
        RecyclerListAdapter3.STRINGS3[1] = "<p>&nbsp;&nbsp;&nbsp; <span style=\"color: #0000ff;\">var</span> withSpace = text + <span style=\"color: #008000;\">\" \"</span></p>";
        RecyclerListAdapter3.STRINGS3[2] = "<p>&nbsp;&nbsp;&nbsp; <em><span style=\"color: #003300;\">println</span></em>(withSpace)<br />}</p>";
  ...
  /*      ItemTouchHelper.Callback callback =
        ...
        view.findViewById(R.id.button_forward_dd).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                NavHostFragment.findNavController(F_DD_6_10_wrong.this)
                        .navigate(R.id.action_f_DD_6_10_wrong_to_t_6_11);
            }
