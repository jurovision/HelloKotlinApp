...
class F_MC_5_6_wrong : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val text =
            "<p><span style=\"color: #ff0000;\">Nicht ganz.</span><strong><em> i = i +1</em></strong> f&uuml;hrt die Anweisung 3-mal aus. Option 3 gibt nur 2-mal Text aus und Option 1 w&uuml;rde theoretisch unendlich lange laufen.</p>"
...
// 2te Antwort richtig
        ...
        view.findViewById<Button>(R.id.button_forward).setOnClickListener {
            ...
            findNavController().navigate(R.id.action_f_MC_5_6_wrong_to_i_5_7)
        }
