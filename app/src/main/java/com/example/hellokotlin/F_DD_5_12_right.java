...
import com.example.hellokotlin.RecyclerListAdapter3;

public class F_DD_5_12_right extends Fragment {

    public F_DD_5_12_right() {
    }


    TextView textview;
    String text = "<p><span style=\"color: #008000;\">Gut gemacht.</span> Nur <strong>zwischen</strong> den geschwungenen Klammern der Schleife k&ouml;nnen wir <em><strong>zahl</strong> </em>hier bedenkenlos benutzen.</p>";
  ...
  /*      ItemTouchHelper.Callback callback =
        ...
        view.findViewById(R.id.button_forward_dd).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                NavHostFragment.findNavController(F_DD_5_12_right.this)
                        .navigate(R.id.action_f_DD_5_12_right_to_t_5_13);
            }
