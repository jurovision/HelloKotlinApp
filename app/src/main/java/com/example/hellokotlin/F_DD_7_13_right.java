...
public class F_DD_7_13_right extends Fragment {

    public F_DD_7_13_right() {
    }

    //Zu ändernden Text festlegen
    TextView textview;
    String text = "<p><span style=\"color: #008000;\">Absolut richtig.</span> Zuerst im Code muss die <strong>Klasse</strong> stehen. Danach k&ouml;nnen wir aus ihr ein <strong>Objekt</strong> <strong>erzeugen</strong> und die <strong>Funktion</strong> <strong>ausf&uuml;hren</strong>.</p>";
    Button textview_button;
    String text_button = "Weiter";

    //Progress Text
    TextView progressText;
    String progress = "13 / 16";

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        RecyclerListAdapter4.STRINGS[0] = "<p><span style=\"color: #0000ff;\">class</span> Hund{</p>";
        RecyclerListAdapter4.STRINGS[1] = "<p><span style=\"color: #0000ff;\">&nbsp;&nbsp;&nbsp; fun</span> bellen(){<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span style=\"color: #003300;\"><em>println</em></span>(<span style=\"color: #008000;\">\"Wuff!\"</span>)<br />&nbsp;&nbsp;&nbsp; }<br />}</p>";
        RecyclerListAdapter4.STRINGS[2] ="<p><span style=\"color: #0000ff;\">val</span> scooby = Hund()</p>";
        RecyclerListAdapter4.STRINGS[3] ="<p>scooby.bellen()</p>";
  ...
  /*      ItemTouchHelper.Callback callback =
        ...
        view.findViewById(R.id.button_forward_dd).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                NavHostFragment.findNavController(F_DD_7_13_right.this)
                        .navigate(R.id.action_f_DD_7_13_right_to_t_7_14);
            }
