...
public class F_DD_1_8_right extends Fragment {

    public F_DD_1_8_right() {
    }


    TextView textview;
    String text = "<p><span style=\"color: #008000;\">Genau!</span> Wir m&uuml;ssen die Variable zuerst <strong>anlegen</strong>, d&uuml;rfen sie dann <strong>&auml;ndern</strong> und k&ouml;nnen sie danach <strong>ausgeben</strong>. </p>";
  ...
  /*      ItemTouchHelper.Callback callback =
        ...
        view.findViewById(R.id.button_forward_dd).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                NavHostFragment.findNavController(F_DD_1_8_right.this)
                        .navigate(R.id.action_f_DD_1_8_right_to_MC_1_6);
            }
