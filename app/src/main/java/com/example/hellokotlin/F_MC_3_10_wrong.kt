 ...
 */
class F_MC_3_10_wrong : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val text =
            "<div style=\"-en-clipboard: true;\"><span style=\"color: #ff0000;\">Leider falsch getippt.</span> Addition, Subtraktion und Co. haben nichts mit Boolschen Werten zu tun \uD83D\uDE09</div>"
...
// 1te Antwort richtig
        ...
        view.findViewById<Button>(R.id.button_forward).setOnClickListener {
            ...
            findNavController().navigate(R.id.action_f_MC_3_10_wrong_to_DD_3_11)
        }
