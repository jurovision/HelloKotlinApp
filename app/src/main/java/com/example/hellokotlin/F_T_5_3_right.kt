...
class F_T_5_3_right : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val text = "<p><span style=\"color: #008000;\">Genau</span>, mit <em><strong>repeat(4)</strong></em> k&ouml;nnen wir eine Anweisung 4-mal ausf&uuml;hren. Das <em>\\n</em> sorgt f&uuml;r den Zeilenumbruch.</p>\n" +
        ...
        view.findViewById<Button>(R.id.button3).setOnClickListener {
            findNavController().navigate(R.id.action_f_T_5_3_right_to_i_5_4)
        }
    }
}
