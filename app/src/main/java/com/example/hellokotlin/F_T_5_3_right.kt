...
class F_T_5_3_right : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val text = "<p><span style=\"color: #008000;\">Genau,</span> mit <em><strong>repeat(4)</strong></em> k&ouml;nnen wir eine Anweisung 4-mal ausf&uuml;hren.</p>\n" +
        ...
        view.findViewById<Button>(R.id.button_inputanswer).setOnClickListener {
            findNavController().navigate(R.id.action_f_T_5_3_right_to_MC_5_4)
        }
    }
}
