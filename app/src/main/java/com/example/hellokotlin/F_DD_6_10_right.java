...
public class F_DD_6_10_right extends Fragment {

    public F_DD_6_10_right() {
    }


    TextView textview;
    String text = "<p><span style=\"color: #008000;\">Stimmt!</span> Au&szlig;erhalb der Funktion existiert <em><strong>text</strong> </em>nicht und beim Verwenden w&uuml;rden wir eine Fehlermeldung bekommen.</p>";
  ...
  /*      ItemTouchHelper.Callback callback =
        ...
        view.findViewById(R.id.button_forward_dd).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                NavHostFragment.findNavController(F_DD_6_10_right.this)
                        .navigate(R.id.action_f_DD_6_10_right_to_t_6_11);
            }
