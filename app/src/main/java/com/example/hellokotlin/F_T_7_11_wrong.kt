...
class F_T_7_11_wrong : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val text = "<p><span style=\"color: #ff0000;\">Nicht ganz.</span> Ziemlich elegant, oder? Achte darauf, dass wir Objekte mit <em><strong>val</strong> </em>anlegen, damit sie sp&auml;ter nicht in Objekte anderer Klassen ver&auml;nderbar sind.</p>\n" +
