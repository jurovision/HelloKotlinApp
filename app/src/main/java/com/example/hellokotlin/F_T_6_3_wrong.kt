...
class F_T_6_3_wrong : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val text = "<p><span style=\"color: #ff0000;\">Nicht ganz.</span> Wir rufen Funktionen mit ihrem <strong>Funktionsnamen</strong> und <strong>runden Klammern</strong>.</p>\n" +
        ...
        view.findViewById<Button>(R.id.button_inputanswer).setOnClickListener {
            findNavController().navigate(R.id.action_f_T_6_3_wrong_to_t_6_4)
        }
    }
}