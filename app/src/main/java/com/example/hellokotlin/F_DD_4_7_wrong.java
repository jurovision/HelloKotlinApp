...
public class F_DD_4_7_wrong extends Fragment {

    public F_DD_4_7_wrong() {
    }

    //Zu ändernden Text festlegen
    TextView textview;
    String text = "<p><span style=\"color: #ff0000;\">Nicht ganz.</span> Nat&uuml;rlich wollen wir sichergehen, dass wir Tom nur an seinem Geburtstag gratulieren \uD83D\uDE09</p>";
