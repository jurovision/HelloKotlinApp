...
class F_T_7_9_wrong : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val text = "<p><span style=\"color: #ff0000;\">Das ist nicht korrekt.</span> Wir greifen mit dem <strong>Punkt Operator</strong> auf das Objekt zu und &auml;ndern den Wert wie wir es von Variablen kennen.</p>\n" +
