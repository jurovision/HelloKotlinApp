...
class F_T_4_12_right : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val text = "<p><span style=\"color: #008000;\">Gut gemacht!</span> Wir greifen mit den eckigen Klammern und dem Index auf Elemente zu. Versuchen wir, auf ein Element zuzugreifen, das au&szlig;erhalb des Arrays liegt (also hier z.B. namen[3] oder h&ouml;her), bekommen wir eine Fehlermeldung. Wir k&ouml;nnen alternativ auch mit <em><strong>namen.get(2)</strong></em> auf \"Sheldon\" zugreifen.</p>\n" +
