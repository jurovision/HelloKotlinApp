...
class I_4_13 : Fragment() {
        ...
        override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
            ...
            val text = "<p>Aber wie k&ouml;nnen wir die <strong>L&auml;nge</strong> eines Arrays wissen, das wir nicht kennen? Kotlin hat mit .<strong>size</strong> eine praktische L&ouml;sung hierf&uuml;r. Zur&uuml;ckgegeben wird dabei die Anzahl der Elemente, also hier 4.</p>\n" +
