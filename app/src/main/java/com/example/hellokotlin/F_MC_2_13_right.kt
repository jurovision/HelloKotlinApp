 ...
 */
class F_MC_2_13_right : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val text =
            "<p><span style=\"color: #008000;\">Korrekt.</span> Wir k&ouml;nnen den Wert einer Variable var <strong>unbegrenzt</strong> oft &auml;ndern. Die anderen Aussagen &uuml;ber Variablen sind richtig.</p>"
        ...
        view.findViewById<Button>(R.id.button_forward).setOnClickListener {
            ...
            findNavController().navigate(R.id.action_f_MC_2_13_right_to_t_2_14)
        }
