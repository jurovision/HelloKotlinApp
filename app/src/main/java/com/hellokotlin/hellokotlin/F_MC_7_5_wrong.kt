...
class F_MC_7_5_wrong : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val text =
            "<p><span style=\"color: #ff0000;\">Nein.</span> W&auml;hrend die anderen 3 reale Personen aus Fleisch und Blut sind, existiert Buzz Lightyear nur in Filmen usw. \uD83D\uDE09 Er ist keine Instanz einer Person.</p>"
        ...
        view.findViewById<Button>(R.id.button_forward).setOnClickListener {
            ...
            findNavController().navigate(R.id.action_f_MC_7_5_wrong_to_i_7_6)
        }
