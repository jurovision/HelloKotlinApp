...
class F_MC_2_2_wrong : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val text =
            "<p><span style=\"color: #ff0000;\">Stimmt leider nicht.</span> Werte, die <strong>nicht ver&auml;nderbar</strong> sein sollen, kannst du mit dem Schl&uuml;sselwort <em><strong>val</strong> </em>anlegen. <em><strong>var</strong> </em>Werte sind nicht vor Ver&auml;nderung sicher.</p>\n" +
        ...
        view.findViewById<Button>(R.id.button_forward).setOnClickListener {
            ...
            findNavController().navigate(R.id.action_f_MC_2_2_wrong_to_i_2_3)
        }
