 ...
 */
class MC_3_6 : Fragment(), View.OnClickListener{
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val text =
            "<p>Manchmal wollen wir &uuml;berpr&uuml;fen, ob Werte <strong>ungleich</strong> sind. Was denkst du, wie das geht?</p>\n" +
                    "<p><span style=\"color: #0000ff;\">var</span> ergebnis = <span style=\"color: #3366ff;\">3.0</span> ____ <span style=\"color: #3366ff;\">3.1415926535</span> </p>"
