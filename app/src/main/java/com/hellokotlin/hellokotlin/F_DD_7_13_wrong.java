...
public class F_DD_7_13_wrong extends Fragment {

    public F_DD_7_13_wrong() {
    }

    //Zu ändernden Text festlegen
    TextView textview;
    String text = "<p><span style=\"color: #ff0000;\">Fast.</span> Zuerst im Code muss die <strong>Klasse</strong> stehen. Danach k&ouml;nnen wir aus ihr ein <strong>Objekt</strong> <strong>erzeugen</strong> und die <strong>Funktion</strong> <strong>ausf&uuml;hren</strong>.</p>";
  ...
  /*      ItemTouchHelper.Callback callback =
        ...
        view.findViewById(R.id.button_forward_dd).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                NavHostFragment.findNavController(F_DD_7_13_wrong.this)
                        .navigate(R.id.action_f_DD_7_13_wrong_to_t_7_14);
            }
