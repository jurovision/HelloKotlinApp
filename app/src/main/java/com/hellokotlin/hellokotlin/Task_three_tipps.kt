...
class Task_three_tipps : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val text1 = "<p>Tipps:</p>\n" +
                "<ul>\n" +
                "<li>Die Aufgabe l&auml;sst sich gut mit einer Schleife l&ouml;sen</li>\n" +
                "<li>F&uuml;r Schleifen hatten wir uns eine Art des Iterierens angesehen, die z.B. jeden Buchstaben eines Strings ausgibt. Vielleicht ist dieser Ansatz hier n&uuml;tzlich?</li>\n" +
                "</ul>\n" +
                "<p>&nbsp;</p>"
