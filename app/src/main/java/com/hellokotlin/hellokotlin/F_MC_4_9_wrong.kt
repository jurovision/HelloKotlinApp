...
class F_MC_4_9_wrong : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val text =
            "<p><span style=\"color: #ff0000;\">Das stimmt so nicht.</span> Arrays m&uuml;ssen in Kotlin immer <strong>Daten des selben Typs</strong> enthalten und d&uuml;rfen keine Typen mischen. Deshalb ist Option 3 falsch. </p>"
        ...
        view.findViewById<Button>(R.id.button_forward).setOnClickListener {
            ...
            findNavController().navigate(R.id.action_f_MC_4_9_wrong_to_i_4_10)
        }
